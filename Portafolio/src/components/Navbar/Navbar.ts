...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      // Solo cargamos el script de terceros de Google Translate si el
      // visitante ya había elegido ES en una visita anterior (cookie
      // presente). Si no, se difiere hasta que pulse el botón de idioma:
      // así la mayoría de visitas no pagan el coste de ese script externo.
